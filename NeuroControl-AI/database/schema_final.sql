-- ================================================================
-- NeuroControl AI - Production Industrial Database Schema (FINAL)
-- ================================================================
...
-- ================================================================
-- Initial System Configuration (FIXED JSON SYNTAX)
-- ================================================================
...
BEGIN
    ...
    SELECT 
        ...
        pg_size_pretty(pg_total_relation_size(schemaname::regclass, tablename::regclass) - pg_relation_size(schemaname::regclass, tablename::regclass)) as index_size_mb
